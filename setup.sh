...
TERM_PACKAGES="$TERM_PACKAGES bash-git-prompt"
...
TERM_PACKAGES="$TERM_PACKAGES graphviz"
...
TERM_PACKAGES="$TERM_PACKAGES python-setuptools"
TERM_PACKAGES="$TERM_PACKAGES scrcpy"
...
if [ ! "$(brew ls --versions openjdk@17)" ]; then
    brew install -v openjdk@17
